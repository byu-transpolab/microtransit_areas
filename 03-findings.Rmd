...
We calculated several metrics from the output of our base ("South SL County only") scenario and compared them with data from UTA's report on their pilot program [@UTAevalQ1, @UTAevalQ2, @UTAevalQ3, @UTAevalQ4].
...
These metrics are given in Table \@ref(tab:comparison).
